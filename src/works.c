...
int main() {
	...
	// xは最小の1となる．つまりp(1)=1となりうる．
	// その1つ少ない値である0においては、仕事量上限が0で必ず仕事を割り振れない．
	// 必ずp(0)=0であると考えてよいので、これを初期値とする．
	lb = 0;

	// A[i]がすべてが最大の10^4で，kが最小の1，nが最大の10^5であった場合（つまり最大の仕事量負担が最も多くなるであろう状況を考えた場合）
	// xは最大の10^9となる．つまり1人あたりの最大仕事量が10^9であれば入力制約内のあらゆる状況に対応できることになる．
	// よって必ずp(10^9)=1となるので、これを初期値とする．
	ub = 1E+9;
